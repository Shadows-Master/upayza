...
const AboutUs = () => {
  return (
    <div id="content" className="site-content">
            ...
            <div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
              <div className="service-box s-box">
                ...
                <div className="content-box">
                  <h5>Simplicity</h5>
                  <p>Real-time transactions | Single integration.</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
              <div className="service-box s-box">
                ...
                <div className="content-box">
                  <h5>Launch</h5>
                  <p>Easy API with single contract &amp; integration</p>
                </div>
              </div>
            </div>
      ...
      <section className="team-v3">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 mt--170">
              <div className="cta">
                <div className="row">
                  <div className="col-md-9 text-center text-md-left mb-4 mb-md-0">
                    <div className="ot-heading">
                      <span>
                        We unlock access, scaling up your business beyond
                        border.
                      </span>
                      <h2 className="main-heading">
